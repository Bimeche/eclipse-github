...
public class Style implements Comparable<Genre>{
	...
	public float comparer(Style s){
		...
		// Ici �a ne marche pas parce que le type style n'est pas castable en type Genre,
		// �a marche dans la comparaison parce que tu ne compare que des styles entre eux, moi j'envoie des genres parfois
